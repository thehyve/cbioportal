...
public class GeneticProfileReader {
    ...
    public static GeneticProfile loadGeneticProfile(File file) throws IOException, DaoException {
        ...
        if (geneticProfile.getGeneticAlterationType() == GeneticAlterationType.TREATMENT_RESPONSE) {
    ...
    /**
     * Check whether required columns for treatment response data were defined in the meta file
     */
