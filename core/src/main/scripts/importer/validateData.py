...
VALIDATOR_IDS = {
    ...
    cbioportal_common.MetaFileTypes.TREATMENT_RESPONSE:'TreatmentValidator'
}
...
class PortalInstance(object):
    ...
    def __init__(self, cancer_type_dict, hugo_entrez_map, alias_entrez_map, geneset_id_list, treatment_map):
...
def request_from_portal_api(server_url, api_name, logger):
    ...
    if api_name == 'genesets' or api_name == 'treatments':
...
def index_treatment_data(json_data,
    ...
    for data_item in json_data:
        ...
        result_dict[treatment_id] = data_item
    return result_dict
