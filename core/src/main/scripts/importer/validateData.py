...
class GenePanelMatrixValidator(Validator):
    ...
    # TODO check that sample ids are references in clinical data file
...
def process_metadata_files(directory, portal_instance, logger, relaxed_mode=False, strict_maf_checks=False):
    ...
    return (validators_by_type, defined_case_list_fns,
            study_cancer_type, study_id, stable_ids)
...
def validate_study(study_dir, portal_instance, logger, relaxed_mode=False, strict_maf_checks=False):
    ...
    (validators_by_meta_type,
     ...
     study_cancer_type,
     study_id,
     stable_ids) = process_metadata_files(study_dir, portal_instance, logger, relaxed_mode, strict_maf_checks)
