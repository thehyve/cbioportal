...
class MutationsSpecialCasesTestCase(PostClinicalDataFileTestCase):
    ...
    def test_alternative_notation_for_intergenic_mutation(self):
        ...
        # INFO should be something like: "does not support variants with Variant Classification 'IGR'
        self.assertIn("does not support variants with variant classification 'igr'", record_list[4].getMessage().lower())
