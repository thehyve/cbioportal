...
5. **NCBI_Build (Required)**: The reference genome used. Allowed values: hg19, hg38, mm10, GRCh37, GRCh38 or GRCm38.

Next to Hugo_Symbol, it is recommended to have the Entrez gene ID:

6. **Entrez_Gene_Id (Optional, but recommended)** : An [Entrez Gene](http://www.ncbi.nlm.nih.gov/gene) identifier.
...
4. **NCBI_Build (Required)<sup>1</sup>**: The reference genome used. Allowed values: hg19, hg38, mm10, GRCh37, GRCh38 or GRCm38.
