...
Define the columns that are going to be visible in the Mutation Copy-Number and Structural Variant Tables on the Patient View and the Results View. If namespace columns are set to visible by default, they will also be shown.
