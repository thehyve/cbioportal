...
VALUES ('brca', 'Breast Invasive Carcinoma', 'HotPink', 'Breast', 'tissue');
INSERT INTO type_of_cancer (TYPE_OF_CANCER_ID, NAME, DEDICATED_COLOR, SHORT_NAME, PARENT)
VALUES ('acc', 'Adrenocortical Carcinoma', 'Purple', 'ACC', 'adrenal_gland');

INSERT INTO `reference_genome`
VALUES (1, 'human', 'hg19', 'GRCh37', NULL, 'http://hgdownload.cse.ucsc.edu/goldenPath/hg19/bigZips',
        '2009-02-01 00:00:00');
INSERT INTO `reference_genome`
VALUES (2, 'human', 'hg38', 'GRCh38', NULL, 'http://hgdownload.cse.ucsc.edu/goldenPath/hg38/bigZips',
        '2013-12-01 00:00:00');

INSERT INTO cancer_study (CANCER_STUDY_ID, CANCER_STUDY_IDENTIFIER, TYPE_OF_CANCER_ID, NAME, DESCRIPTION, PUBLIC, PMID,
                          CITATION, GROUPS, STATUS, IMPORT_DATE, REFERENCE_GENOME_ID)
...
INSERT INTO reference_genome_gene (ENTREZ_GENE_ID,REFERENCE_GENOME_ID,CHR,CYTOBAND,`START`,`END`) VALUES(207,1,14,'14q32.33',105235686,105262088);
INSERT INTO reference_genome_gene (ENTREZ_GENE_ID,REFERENCE_GENOME_ID,CHR,CYTOBAND,`START`,`END`) VALUES(207,2,14,'14q32.33',104769349,104795751);
INSERT INTO reference_genome_gene (ENTREZ_GENE_ID,REFERENCE_GENOME_ID,CHR,CYTOBAND,`START`,`END`) VALUES(208,1,19,'19q13.2',40736224,40791443);
INSERT INTO reference_genome_gene (ENTREZ_GENE_ID,REFERENCE_GENOME_ID,CHR,CYTOBAND,`START`,`END`) VALUES(208,2,19,'19q13.2',40230317,40285536);
...
INSERT INTO geneset_hierarchy_node (NODE_ID, NODE_NAME, PARENT_ID)
VALUES (2, 'Sub node A', 1);
INSERT INTO geneset_hierarchy_node (NODE_ID, NODE_NAME, PARENT_ID)
VALUES (3, 'Sub node B', 1);
INSERT INTO geneset_hierarchy_node (NODE_ID, NODE_NAME, PARENT_ID)
VALUES (4, 'Parent node 1', 2);
INSERT INTO geneset_hierarchy_node (NODE_ID, NODE_NAME, PARENT_ID)
VALUES (5, 'Parent node 2', 2);

INSERT INTO geneset_hierarchy_leaf (NODE_ID, GENESET_ID)
VALUES (4, 1);
INSERT INTO geneset_hierarchy_leaf (NODE_ID, GENESET_ID)
VALUES (4, 2);
INSERT INTO geneset_hierarchy_leaf (NODE_ID, GENESET_ID)
...
INSERT INTO mutation_count_by_keyword (GENETIC_PROFILE_ID, KEYWORD, ENTREZ_GENE_ID, KEYWORD_COUNT, GENE_COUNT)
VALUES (6, 'AKT1 truncating', 207, 54, 64);
INSERT INTO mutation_count_by_keyword (GENETIC_PROFILE_ID, KEYWORD, ENTREZ_GENE_ID, KEYWORD_COUNT, GENE_COUNT)
VALUES (6, NULL, 207, 21, 22);
INSERT INTO mutation_count_by_keyword (GENETIC_PROFILE_ID, KEYWORD, ENTREZ_GENE_ID, KEYWORD_COUNT, GENE_COUNT)
VALUES (6, 'ARAF G1513 missense', 369, 1, 2);
INSERT INTO mutation_count_by_keyword (GENETIC_PROFILE_ID, KEYWORD, ENTREZ_GENE_ID, KEYWORD_COUNT, GENE_COUNT)
VALUES (6, 'ARAF G1514 missense', 369, 4, 7);
INSERT INTO mutation_count_by_keyword (GENETIC_PROFILE_ID, KEYWORD, ENTREZ_GENE_ID, KEYWORD_COUNT, GENE_COUNT)
VALUES (8, 'NOC2L truncating', 26155, 1, 3);

INSERT INTO users (EMAIL, NAME, ENABLED)
VALUES ('mockemail@email.com', 'MOCK USER', 1);
INSERT INTO users (EMAIL, NAME, ENABLED)
VALUES ('mockemail2@email.com', 'MOCK USER 2', 1);
INSERT INTO users (EMAIL, NAME, ENABLED)
VALUES ('mockemail3@email.com', 'MOCK USER 3', 1);
INSERT INTO users (EMAIL, NAME, ENABLED)
VALUES ('mockemail4@email.com', 'MOCK USER 4', 1);

INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('6c9a641e-9719-4b09-974c-f17e089b37e8', 'mockemail@email.com', '2018-11-12 11:11:15+00:00',
        '2018-10-12 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('6c9a641e-9719-fake-data-f17e089b37e8', 'mockemail2@email.com', '2018-5-14 11:11:15+00:00',
        '2018-4-14 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('12345678 - 119e-4bC9-9a4c-f123kl9b37e8', 'mockemail3@email.com', '2017-1-12 11:11:15+00:00',
        '2016-12-12 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('6c9a641e-9719-4b09-974c-4rb1tr4ry5tr', 'mockemail3@email.com', '2017-10-9 11:11:15+00:00',
        '2017-9-9 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('1337rand-ki1n-4bna-974c-s4sk3n4rut0l', 'mockemail3@email.com', '2018-8-25 11:11:15+00:00',
        '2018-7-25 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('12445678 - 119e-4bC9-9a4c-f124kl9b47e8', 'mockemail4@email.com', '2017-1-12 11:11:15+00:00',
        '2016-12-12 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('6cokl41e-9719-4b09-974c-4rb1tr4ry5tr', 'mockemail4@email.com', '2017-10-9 11:11:15+00:00',
        '2017-9-9 11:11:15+00:00');
INSERT INTO data_access_tokens (TOKEN, USERNAME, EXPIRATION, CREATION)
VALUES ('1447rand-ki1n-4bna-974c-s4sk4n4rut0l', 'mockemail4@email.com', '2018-8-25 11:11:15+00:00',
        '2018-7-25 11:11:15+00:00');

-- treatment test data
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (1, 19, 'NAME', 'Tanespimycin');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (2, 19, 'DESCRIPTION', 'Hsp90 inhibitor');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (3, 19, 'URL', 'https://en.wikipedia.org/wiki/Tanespimycin');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (4, 20, 'NAME', 'Larotrectinib');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (5, 20, 'DESCRIPTION', 'TrkA/B/C inhibitor');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (6, 20, 'URL', 'https://en.wikipedia.org/wiki/Larotrectinib');
INSERT INTO genetic_alteration (GENETIC_PROFILE_ID, GENETIC_ENTITY_ID, `VALUES`)
VALUES (11, 19, ' - 0.0670, -0.6270, -1.2266, -1.2079, -1.2262, 0.6962, -0.3338, -0.1260, 0.7559, -1.1267, -0.5893,
        -1.1506, -1.0027, -1.3157, ');
INSERT INTO genetic_alteration (GENETIC_PROFILE_ID, GENETIC_ENTITY_ID, `VALUES`)
VALUES (11, 20, '1.0106, -0.0662, -0.8585, -1.6576, -0.3552, -0.8306, 0.8102, 0.1106, 0.3098, 0.0309, 0.0927, -0.8665,
        -0.0750, -0.7221, ');

-- allele specific copy number data
INSERT INTO allele_specific_copy_number (MUTATION_EVENT_ID, GENETIC_PROFILE_ID, SAMPLE_ID, ASCN_INTEGER_COPY_NUMBER,
                                         ASCN_METHOD, CCF_EXPECTED_COPIES_UPPER, CCF_EXPECTED_COPIES, CLONAL,
                                         MINOR_COPY_NUMBER, EXPECTED_ALT_COPIES, TOTAL_COPY_NUMBER)
VALUES (2040, 6, 1, 3, 'FACETS', 1.25, 1.75, 'CLONAL', 2, 1, 4);
INSERT INTO allele_specific_copy_number (MUTATION_EVENT_ID, GENETIC_PROFILE_ID, SAMPLE_ID, ASCN_INTEGER_COPY_NUMBER,
                                         ASCN_METHOD, CCF_EXPECTED_COPIES_UPPER, CCF_EXPECTED_COPIES, CLONAL,
                                         MINOR_COPY_NUMBER, EXPECTED_ALT_COPIES, TOTAL_COPY_NUMBER)
VALUES (2038, 6, 6, 1, 'FACETS', 1.25, 1.75, 'SUBCLONAL', 1, 1, 2);
-- generic assay test data
-- mutational signature test data
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (7, 28, 'name', 'mean_1');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (8, 28, 'description', 'description of mean_1');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (9, 29, 'name', 'mean_2');
INSERT INTO generic_entity_properties (ID, GENETIC_ENTITY_ID, `NAME`, `VALUE`)
VALUES (10, 29, 'description', 'description of mean_2');

INSERT INTO genetic_alteration (GENETIC_PROFILE_ID, GENETIC_ENTITY_ID, `VALUES`)
VALUES (12, 28, ' - 0.0670, -0.6270, -1.2266, -1.2079, -1.2262, 0.6962, -0.3338, -0.1260, 0.7559, -1.1267, -0.5893,
        -1.1506, -1.0027, -1.3157, ');
INSERT INTO genetic_alteration (GENETIC_PROFILE_ID, GENETIC_ENTITY_ID, `VALUES`)
VALUES (12, 29, '1.0106, -0.0662, -0.8585, -1.6576, -0.3552, -0.8306, 0.8102, 0.1106, 0.3098, 0.0309, 0.0927, -0.8665,
        -0.0750, -0.7221, ');