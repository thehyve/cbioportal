...
--%>
<div class='section cbioportal-frontend' id='data_external_tab'>
</div>
...
<script>
    ...
    $(document).ready( function() {
    	...
    	function tabsUpdate() {
    		if ($("#data_external_tab").is(":visible")) {
	    		if (tab_init === false) {
                    window.onReactAppReady(function(){
                        window.renderExternalTab(document.getElementById('data_external_tab'));
                    });
                    tab_init = true;
                } 
	    	}
