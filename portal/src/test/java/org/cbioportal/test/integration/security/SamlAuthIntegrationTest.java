...
@TestPropertySource(
    properties = {
        ...
        "saml.roles-from-database=false", // Somehow the @Value default does not seem to work.
...
public class SamlAuthIntegrationTest {
    ...
    public void downloadOfflineToken() throws Exception {
        RemoteWebDriver driver = performLogin();
        driver.manage().timeouts().implicitlyWait(2, TimeUnit.SECONDS); // Wait to load new page after click of Data Access Token link.
        Assertions.assertDoesNotThrow(
