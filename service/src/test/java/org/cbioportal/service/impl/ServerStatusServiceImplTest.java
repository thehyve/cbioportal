...
public class ServerStatusServiceImplTest extends BaseServiceImplTest {
    ...
    public void getServerStatusSuccess() throws Exception {
        ...
        String status = serverStatusService.getServerStatus();

        Assert.assertEquals(ServerStatusServiceImpl.MESSAGE_RUNNING, status);
    }
    ...
    public void getServerStatusFailure() throws Exception {
        ...
        Assert.assertEquals(ServerStatusServiceImpl.MESSAGE_DOWN, status);
    }
