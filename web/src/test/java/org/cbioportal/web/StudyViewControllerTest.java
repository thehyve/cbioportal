...
public class StudyViewControllerTest {
    ...
    public void fetchClinicalDataClinicalTable() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/clinical-data-table/fetch")
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
            .andExpect(MockMvcResultMatchers.jsonPath("$[0].clinicalAttributeId").value(TEST_ATTRIBUTE_ID))
            .andExpect(MockMvcResultMatchers.jsonPath("$[0].sampleId").value(TEST_SAMPLE_ID_1))
            .andExpect(MockMvcResultMatchers.jsonPath("$[1].clinicalAttributeId").value(TEST_ATTRIBUTE_ID))
            .andExpect(MockMvcResultMatchers.jsonPath("$[1].sampleId").value(TEST_SAMPLE_ID_2))
            .andExpect(MockMvcResultMatchers.jsonPath("$[2].clinicalAttributeId").value(TEST_ATTRIBUTE_ID))
            .andExpect(MockMvcResultMatchers.jsonPath("$[2].sampleId").value(TEST_SAMPLE_ID_3))
            .andExpect(MockMvcResultMatchers.jsonPath("$[3].clinicalAttributeId").value(TEST_ATTRIBUTE_ID))
            .andExpect(MockMvcResultMatchers.jsonPath("$[3].sampleId").value(TEST_SAMPLE_ID_1))
            .andExpect(MockMvcResultMatchers.jsonPath("$[4].clinicalAttributeId").value(TEST_ATTRIBUTE_ID))
            .andExpect(MockMvcResultMatchers.jsonPath("$[4].sampleId").value(TEST_SAMPLE_ID_2))
            .andExpect(MockMvcResultMatchers.jsonPath("$[5].clinicalAttributeId").value(TEST_ATTRIBUTE_ID))
            .andExpect(MockMvcResultMatchers.jsonPath("$[5].sampleId").value(TEST_SAMPLE_ID_3));
    }
